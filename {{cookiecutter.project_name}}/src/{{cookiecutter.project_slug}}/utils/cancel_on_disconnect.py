...
class CancelOnDisconnect:
    """
    Context manager that cancels the current task when the client disconnects.

    Useful for long-running requests (like AI operations) to avoid wasting resources
    when the client is no longer interested in the result.
